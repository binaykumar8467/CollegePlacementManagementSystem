...
router.post("/student/signup/request-otp", asyncHandler(ctrl.requestStudentSignupOtp));
router.post("/student/signup/verify-otp", asyncHandler(ctrl.verifyStudentSignupOtp));
...
router.post("/tpo/signup/request-otp", asyncHandler(ctrl.requestTpoSignupOtp));
router.post("/tpo/signup/verify-otp", asyncHandler(ctrl.verifyTpoSignupOtp));
